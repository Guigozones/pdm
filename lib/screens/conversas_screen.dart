...
class _ConversasScreenState extends State<ConversasScreen> {
  final List<Map<String, dynamic>> conversas = [
    {
      ...
      'time': '10:30',
      'message': 'A que horas você passa no meu local de embarque?',
      'unread': true,
    },
    {
      'name': 'João Gomes',
      ...
      'time': '09:33',
      'message': 'Obrigado! Até amanhã!',
      'unread': false,
    },
    {
      'name': 'Simone Simária',
      'route': 'Caxias → São João do Sóter',
      'time': '08:30',
      'message': 'Pode levar uma mala extra?',
      'unread': false,
    },
    {
      'name': 'Henrique Juliano',
      'route': 'Teresina → São João do Sóter',
      'time': '08:30',
      'message': 'Eu vou ter que meus dois cachorrros. Tem algum...',
      'unread': false,
    },
  ];
              ...
              child: Column(
                children: List.generate(
                  ...
                  (index) => Padding(
                    ...
                    child: _conversaCard(conversas[index]),
                  ),
                ),
              ),
            ),
  ...
  Widget _conversaCard(Map<String, dynamic> conversa) {
